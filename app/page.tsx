...
import { ArrowRight, Calendar, ExternalLink, MessageCircle, Users, Zap, Play, Volume2, VolumeX, X } from "lucide-react"
...
import { AutoScrollingEvents } from "@/components/auto-scrolling-events"
import { EnhancedTestimonials } from "@/components/enhanced-testimonials"
import { EnhancedFooter } from "@/components/enhanced-footer"
import "./scrollbar-hide.css"

const ScrollingQuotes = ({ quotes }: { quotes: string[] }) => {
  ...
  return (
    ...
    >
      <p className="text-xl italic text-white/80">{quotes[currentQuoteIndex]}</p>
    </motion.div>
  )
}
...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-indigo-950 to-rose-950 py-24 md:py-32">
        <div className="container mx-auto px-4">
          <FounderHero />
      ...
      <section className="bg-gradient-to-b from-rose-950 to-purple-950 py-24 md:py-32" id="real-voices">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <FloatingCard
              ...
              category="🎤 Interviews"
              image="https://images.pexels.com/photos/3184298/pexels-photo-3184298.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
              delay={0.1}
            />
            <FloatingCard
              title="On the Rise"
            ...
            <FloatingCard
              ...
              category="🎧 Audio"
              image="https://images.pexels.com/photos/3184328/pexels-photo-3184328.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
              delay={0.3}
            />
          </div>
