    ...
    <div className="relative">
            ...
            <div className="grid gap-12 md:grid-cols-2">
              ...
              >
                <div className="h-full rounded-xl bg-black/50 p-6 backdrop-blur-sm">
                  <Image  
                    src="https://images.pexels.com/photos/3184298/pexels-photo-3184298.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=600&w=500"
                    alt="Peali Sarkar"
                    width={500}
                    height={600}
      ...
      <ParallaxSection className="bg-gradient-to-b from-indigo-950 to-purple-950 py-24 text-white md:py-32">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-8">
              <FloatingKeywords
                words={["Growth", "Opportunity", "Transformation", "Mentorship", "Vision", "Purpose"]}
              />
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-black py-24 md:py-32">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.pexels.com/photos/3184405/pexels-photo-3184405.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=1080&w=1920"
